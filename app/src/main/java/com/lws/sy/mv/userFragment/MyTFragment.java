...
public class MyTFragment extends VideoBaseFragment implements View.OnClickListener {
    ...
    public MyTFragment(String title) {
        super.title=title;
    }
    ...
    public void initData() {
        ...
        if(TagUtils.isAvatar){
            request.getData(NET.getUserPost+"&id="+ TagUtils.userid+"&type=1");
        }else{
            request.getData(NET.getUserPost+"&id="+ TagUtils.id+"&type=1");
        }
