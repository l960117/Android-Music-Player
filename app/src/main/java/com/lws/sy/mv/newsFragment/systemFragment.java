...
public class systemFragment extends NewsBaseFragment{
    ...
    public systemFragment(String title) {
        super.title = title;
    }
    ...
    private void initData() {
        request.getData(NET.getNews+"&type=3"+"&id="+ TagUtils.id);
    ...
    private class SystemAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            holder.tv_content.setText("通知");
            holder.tv_title.setText(infos.get(position).getContent());
            holder.iv_news_icon.setImageResource(R.mipmap.information);
